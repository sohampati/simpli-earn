        ...
        <div className="fixed mx-5 top-16 h-[calc(100vh-30px)] left-0 z-100">
            <div className="flex flex-col w-full h-full relative -mt-12">
                ...
                <div className="flex w-full min-h-[83vh]">
                    ...
                    <div className="-mt-10 pt-18 pb-12 px-8 w-full lg:w-3/4 rounded-r-[30px] rounded-l-[30px] lg:rounded-l-none border-b-[0.85px] border-x-[0.85px] border-white/35"><div className="relative h-full"><ChatBot tall={true} /></div></div>
                </div>
            </div>
        </div>
    );
