export default function SummaryFrame() {
  return (
    <div className="flex w-full h-full">
      <div className="w-full h-full font-montserrat text-white mt-[40px] justify-center items-center bg-white/4 rounded-tr-[30px] rounded-bl-[30px] rounded-tl-[30px] border-t-[0.85px] border-l-[0.85px] border-white/25 relative">
        <div className="bottom_section absolute h-[31px] w-[calc(100%-99px)] bg-transparent bottom-0 left-0 rounded-b-[30px] border-b-[0.85px] border-r-[0.85px] border-white/25"></div>
        <div className="right_section absolute z-10 h-[calc(100%-99px)] w-[29px] bg-transparent top-0 right-0 rounded-tr-[30px] rounded-br-[30px] border-r-[0.85px] border-b-[0.85px] border-white/25"></div>
        <div className="inset_area absolute z-1 h-[71px] w-[71px] bg-black/50 w-1/2 bottom-[29px] right-[29px] rounded-tl-[30px] border-t-[0.85px] border-l-[0.85px] border-white/25">
        ...
        <div className="inset_area_bot absolute z-1 h-[99px] w-[29px] bg-black/50 w-1/2 bottom-0 right-0"></div>
        <div className="inset_area_right absolute z-1 h-[29px] w-[70px] bg-black/50 w-1/2 bottom-0 right-[29px]"></div>
